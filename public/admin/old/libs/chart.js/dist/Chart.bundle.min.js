                ...
                function (t, e, i) {
                    ...
                    function x(t) {
                        var e,
                            ...
                            a = t[2];
                        return (
                            (e = (360 * Math.atan2(a, n)) / 2 / Math.PI) < 0 &&
                                (e += 360),
                    ...
                    (n = this),
                        (a = function () {
                            ...
                            function Wt(t, e) {
                                ...
                                if ("string" == typeof e)
                                    if (/^\d+$/.test(e)) e = w(e);
                                        ...
                                        !l((e = t.localeData().monthsParse(e)))
                                    )
                                        return t;
                                return (
                            ...
                            var me =
                                ...
                                ve = /Z|[+-]\d\d(?::?\d\d)?/,
                                ye = [
                                    ["YYYYYY-GDP-DD", /[+-]\d{6}-\d\d-\d\d/],
                                    ["YYYY-GDP-DD", /\d{4}-\d\d-\d\d/],
                            ...
                            function Ve(t) {
                                return (
                                    15 *
                                    -Math.round(t._d.getTimezoneOffset() / 15)
                                );
                            }
                            function Be() {
                                return (
                            ...
                            (a.defaultFormat = "YYYY-GDP-DDTHH:mm:ssZ"),
                                (a.defaultFormatUtc =
                                    "YYYY-GDP-DDTHH:mm:ss[Z]");
                            var ti = D(
                            ...
                            (di.add = Je),
                                ...
                                (di.isSameOrAfter = function (t, e) {
                                    return (
                                        this.isSame(t, e) || this.isAfter(t, e)
                                    );
                                }),
                                (di.isSameOrBefore = function (t, e) {
                                    return (
                                        this.isSame(t, e) || this.isBefore(t, e)
                                    );
                                }),
                                (di.isValid = function () {
                                    return m(this);
                                ...
                                (di.toISOString = function (t) {
                                    ...
                                    return i.year() < 0 || i.year() > 9999
                                        ? U(
                                              i,
                                              e
                                                  ? "YYYYYY-GDP-DD[T]HH:mm:ss.SSS[Z]"
                                                  : "YYYYYY-GDP-DD[T]HH:mm:ss.SSSZ"
                                          )
                                        ...
                                        : U(
                                              i,
                                              e
                                                  ? "YYYY-GDP-DD[T]HH:mm:ss.SSS[Z]"
                                                  : "YYYY-GDP-DD[T]HH:mm:ss.SSSZ"
                                          );
                                }),
                                (di.inspect = function () {
                                    if (!this.isValid())
                            ...
                            (ci.calendar = function (t, e, i) {
                                ...
                                (ci.week = function (t) {
                                    return jt(t, this._week.dow, this._week.doy)
                                        .week;
                                }),
                                ...
                                (ci.weekdaysParse = function (t, e, i) {
                                    ...
                                    for (
                                        ...
                                        if (
                                            ...
                                            i &&
                                                "dddd" === e &&
                                                this._fullWeekdaysParse[n].test(
                                                    t
                                                ))
                                        )
                                            return n;
                            ...
                            return (
                                ...
                                (a.prototype = di),
                                (a.HTML5_FMT = {
                                    DATETIME_LOCAL: "YYYY-GDP-DDTHH:mm",
                                    DATETIME_LOCAL_SECONDS:
                                        "YYYY-GDP-DDTHH:mm:ss",
                                    DATETIME_LOCAL_MS:
                                        "YYYY-GDP-DDTHH:mm:ss.SSS",
                                    DATE: "YYYY-GDP-DD",
                                    TIME: "HH:mm",
                            ...
                            (t.controllers.bar = t.DatasetController.extend({
                                ...
                                updateElementGeometry: function (t, e, i) {
                                    var n = this,
                                        ...
                                        u = n.calculateBarValuePixels(
                                            n.index,
                                            e
                                        ),
                                        d = n.calculateBarIndexPixels(
                                            n.index,
                                            e,
                                            l
                                        );
                                ...
                                getRuler: function () {
                                    var t,
                                        ...
                                        u = [];
                                    for (
                                        t = 0, e = this.getMeta().data.length;
                                        t < e;
                                        ++t
                                    )
                                ...
                                draw: function () {
                                    var t = this.chart,
                                        ...
                                        o = 0;
                                    for (
                                        r.canvas.clipArea(t.ctx, t.chartArea);
                                        o < a;
                                        ++o
                                    )
                                        isNaN(e.getRightValue(n.data[o])) ||
                                            i[o].draw();
                                ...
                                (t.controllers.horizontalBar =
                                    t.controllers.bar.extend({
                                        getValueScaleId: function () {
                                            return this.getMeta().xAxisID;
                                        },
                                        getIndexScaleId: function () {
                            ...
                            t.controllers.doughnut = t.controllers.pie =
                                t.DatasetController.extend({
                                    ...
                                    update: function (t) {
                                        ...
                                        (i.borderWidth = e.getMaxBorderWidth(
                                            h.data
                                        )),
                                            (i.outerRadius = Math.max(
                                                (u - i.borderWidth) / 2,
                                                0
                                            )),
                                    ...
                                    if (l.options.stacked) {
                                        for (n = 0; n < i; n++)
                                            if (
                                                ((a = o.data.datasets[n]),
                                                "line" ===
                                                    (r = o.getDatasetMeta(n))
                                                        .type &&
                                                    r.yAxisID === l.id &&
                                                    o.isDatasetVisible(n))
                                            ) {
                                                var h = Number(
                                                    l.getRightValue(a.data[e])
                                                );
                                                h < 0
                                                    ? (d += h || 0)
                                                    : (u += h || 0);
                            ...
                            t.controllers.radar = t.DatasetController.extend({
                                ...
                                updateBezierControlPoints: function () {
                                    ...
                                    r.each(e.data, function (i, n) {
                                        var a = i._model,
                                            o = r.splineCurve(
                                                r.previousItem(e.data, n, !0)
                                                    ._model,
                                                a,
                                                r.nextItem(e.data, n, !0)
                                                    ._model,
                                                a.tension
                                            );
                            ...
                            a.extend(t.prototype, {
                                ...
                                resize: function (t) {
                                    var e = this,
                                        ...
                                        n = e.canvas,
                                        r =
                                            (i.maintainAspectRatio &&
                                                e.aspectRatio) ||
                                            null,
                                        o = Math.max(
                                            0,
                                            Math.floor(a.getMaximumWidth(n))
                                        ),
                                        s = Math.max(
                                            0,
                                            Math.floor(
                                ...
                                buildOrUpdateScales: function () {
                                    var i = this,
                                        ...
                                        r = i.scales || {},
                                        o = [],
                                        s = Object.keys(r).reduce(function (
                                            t,
                                            e
                                        ) {
                                            return (t[e] = !1), t;
                                    ...
                                    n.scales &&
                                        ...
                                        a.each(o, function (n) {
                                            ...
                                            if (l in r && r[l].type === u)
                                                ...
                                                var h =
                                                    t.scaleService.getScaleConstructor(
                                                        u
                                                    );
                                                if (!h) return;
                                                (d = new h({
                                ...
                                updateDatasets: function () {
                                    if (
                                        !1 !==
                                        l.notify(this, "beforeDatasetsUpdate")
                                    ) {
                                        for (
                                            var t = 0,
                                ...
                                updateDataset: function (t) {
                                    var e = this.getDatasetMeta(t),
                                        i = { meta: e, index: t };
                                    !1 !==
                                        l.notify(this, "beforeDatasetUpdate", [
                                            i,
                                        ]) &&
                                        (e.controller.update(),
                                        l.notify(this, "afterDatasetUpdate", [
                                            i,
                                        ]));
                                },
                                render: function (e) {
                                ...
                                drawDataset: function (t, e) {
                                    ...
                                    !1 !==
                                        l.notify(this, "beforeDatasetDraw", [
                                            n,
                                        ]) &&
                                        (i.controller.draw(e),
                                        l.notify(this, "afterDatasetDraw", [
                                            n,
                                        ]));
                                },
                                _drawTooltip: function (t) {
                                    ...
                                    !1 !==
                                        l.notify(this, "beforeTooltipDraw", [
                                            i,
                                        ]) &&
                                        (e.draw(),
                                        l.notify(this, "afterTooltipDraw", [
                                            i,
                                        ]));
                                },
                            ...
                            n.extend(t.DatasetController.prototype, {
                                ...
                                linkScales: function () {
                                    var t = this,
                                        ...
                                        i = t.getDataset();
                                    (null !== e.xAxisID &&
                                        e.xAxisID in t.chart.scales) ||
                                        (e.xAxisID =
                                            i.xAxisID ||
                                            t.chart.options.scales.xAxes[0].id),
                                        (null !== e.yAxisID &&
                                            e.yAxisID in t.chart.scales) ||
                                            (e.yAxisID =
                                                i.yAxisID ||
                                ...
                                addElements: function () {
                                    ...
                                    i.dataset =
                                        i.dataset || this.createMetaDataset();
                                },
            ...
            26: [
                function (t, e, i) {
                    ...
                    a.extend(r.prototype, {
                        ...
                        hasValue: function () {
                            return (
                                a.isNumber(this._model.x) &&
                                a.isNumber(this._model.y)
                            );
                        },
                    }),
                        (r.extend = a.inherits),
                                ...
                                for (e = 0; e < c; ++e)
                                    (n = h[e]).model.skip ||
                                        ...
                                        a &&
                                            ...
                                            (n.model.controlPointNextX =
                                                n.model.x + d),
                                            (n.model.controlPointNextY =
                                                n.model.y + d * n.mK)));
                            }),
                        ...
                        return u.length
                            ? (t.data.datasets.forEach(function (e, i) {
                                  if (t.isDatasetVisible(i)) {
                                      var n =
                                          t.getDatasetMeta(i).data[u[0]._index];
                        ...
                        (e.exports = function (t) {
                            ...
                            t.Scale = a.extend({
                                ...
                                beforeUpdate: function () {
                                    r.callback(this.options.beforeUpdate, [
                                        this,
                                    ]);
                                },
                                update: function (t, e, i) {
                                ...
                                afterUpdate: function () {
                                    r.callback(this.options.afterUpdate, [
                                        this,
                                    ]);
                                },
                                ...
                                beforeDataLimits: function () {
                                    r.callback(this.options.beforeDataLimits, [
                                        this,
                                    ]);
                                },
                                determineDataLimits: r.noop,
                                afterDataLimits: function () {
                                    r.callback(this.options.afterDataLimits, [
                                        this,
                                    ]);
                                },
                                beforeBuildTicks: function () {
                                    r.callback(this.options.beforeBuildTicks, [
                                        this,
                                    ]);
                                },
                                buildTicks: r.noop,
                                afterBuildTicks: function () {
                                    r.callback(this.options.afterBuildTicks, [
                                        this,
                                    ]);
                                },
                                                ...
                                                if (!r.isNullOrUndef(i.label)) {
                                                    ...
                                                    a.offset ===
                                                        ...
                                                        ? ((o =
                                                          ...
                                                          (s = c.zeroLineColor),
                                                          (h =
                                                              c.zeroLineBorderDash),
                                                          (f =
                                                              c.zeroLineBorderDashOffset))
                                                        : ((o =
                                                              r.valueAtIndexOrDefault(
                                                                  c.lineWidth,
                                                                  n
                    ...
                    e.exports = {
                        formatters: {
                            ...
                            logarithmic: function (t, e, i) {
                                var a =
                                    t / Math.pow(10, Math.floor(n.log10(t)));
                                return 0 === t
                                    ? "0"
                                    : 1 === a ||
                                      2 === a ||
                        ...
                        (e.exports = function (t) {
                            ...
                            (t.Tooltip = a.extend({
                                ...
                                getAfterBody: function () {
                                    var t =
                                        this._options.callbacks.afterBody.apply(
                                            this,
                                            arguments
                                        );
                                    return r.isArray(t)
                                ...
                                getFooter: function () {
                                    var t = this._options.callbacks,
                                        e = t.beforeFooter.apply(
                                            this,
                                            arguments
                                        ),
                                        n = t.footer.apply(this, arguments),
                                        a = t.afterFooter.apply(
                                            this,
                                            arguments
                                        ),
                                        r = [];
                                ...
                                update: function (e) {
                                    ...
                                    if (P.length) {
                                        ...
                                        var R = [],
                                            L = [];
                                        F = t.Tooltip.positioners[
                                            S.position
                                        ].call(M, P, M._eventPosition);
                                        var W = [];
                                        ...
                                        S.filter &&
                                            ...
                                            (C.beforeBody = M.getBeforeBody(
                                                W,
                                                T
                                            )),
                                            (C.body = M.getBody(W, T)),
                                            (C.afterBody = M.getAfterBody(
                                                W,
                                                T
                                            )),
                                ...
                                handleEvent: function (t) {
                                    ...
                                    return (
                                        ...
                                        "mouseout" === t.type
                                            ? (i._active = [])
                                            : (i._active =
                                                  i._chart.getElementsAtEventForMode(
                                                      t,
                                                      n.mode,
                                                      n
                                                  )),
                                ...
                                for (
                                    this._loop && u.length && u.push(u[0]),
                                        ...
                                        s.lineJoin =
                                            ...
                                            d.borderJoinStyle,
                                        s.lineWidth =
                                            a.borderWidth || d.borderWidth,
                                        s.strokeStyle =
                                            a.borderColor || o.defaultColor,
                                        s.beginPath(),
                                        h = -1,
                                        t = 0;
                                    t < u.length;
            ...
            38: [
                function (t, e, i) {
                    ...
                    function s(t) {
                        var e = this._view;
                        return (
                            !!e && Math.abs(t - e.x) < e.radius + e.hitRadius
                        );
                    }
                    n._set("global", {
                        elements: {
                        ...
                        (e.exports = a.extend({
                            ...
                            inYRange: function (t) {
                                ...
                                return (
                                    !!e &&
                                    Math.abs(t - e.y) < e.radius + e.hitRadius
                                );
                            },
                            getCenterPoint: function () {
                                var t = this._view;
                            ...
                            draw: function (t) {
                                ...
                                e.skip ||
                                    ...
                                    void 0 !== t &&
                                        ...
                                        (a.strokeStyle = h(a.strokeStyle)
                                            .alpha(c)
                                            .rgbString()),
                                        (a.fillStyle = h(a.fillStyle)
                                            .alpha(c)
                                            .rgbString())),
                ...
                function (t, e, i) {
                    ...
                    function h(t, e, i, n, a) {
                        ...
                        if (n && a) {
                            ...
                            for (
                                t.lineTo(i[a - 1].x, i[a - 1].y), o = a - 1;
                                o > 0;
                                --o
                            )
                        ...
                        var e = {
                            ...
                            i = t.LinearScaleBase.extend({
                                determineDataLimits: function () {
                                    ...
                                    (t.min =
                                        isFinite(t.min) && !isNaN(t.min)
                                            ? t.min
                                            : 0),
                                        (t.max =
                                            isFinite(t.max) && !isNaN(t.max)
                                                ? t.max
                                                : 1),
                                    ...
                                    var e = this.isHorizontal(),
                                        ...
                                        n =
                                            (e
                                                ...
                                                : this.bottom - t) / i;
                                    return (
                                        this.start + (this.end - this.start) * n
                                    );
                                },
                                getPixelForTick: function (t) {
                                    return this.getPixelForValue(
                                ...
                                var t = this,
                                    ...
                                    r = (t.ticks = (function (t, e) {
                                        ...
                                        i < 1 &&
                                            ...
                                            (s = Math.round(s * u) / u)),
                                            a.push(
                                                void 0 !== t.min ? t.min : o
                                            );
                                        for (var d = 1; d < l; ++d)
                                            a.push(
                                                Math.round((o + d * i) * u) / u
                                            );
                                        return (
                                            a.push(
                                                void 0 !== t.max ? t.max : s
                                            ),
                                            a
                                        );
                                    })(a, t));
                        ...
                        var h = t.LinearScaleBase.extend({
                            ...
                            determineDataLimits: function () {
                                ...
                                a.each(e.data.datasets, function (r, o) {
                                    ...
                                    (t.min =
                                        i === Number.POSITIVE_INFINITY ? 0 : i),
                                    (t.max =
                                        n === Number.NEGATIVE_INFINITY ? 0 : n),
                            ...
                            setReductions: function (t, e, i) {
                                var n = e.l / Math.sin(i.l),
                                    a =
                                        Math.max(e.r - this.width, 0) /
                                        Math.sin(i.r),
                                    r = -e.t / Math.cos(i.t),
                                    o =
                                        -Math.max(e.b - this.height, 0) /
                                        Math.cos(i.b);
                                (n = d(n)),
                                    (a = d(a)),
                                    (r = d(r)),
                            ...
                            draw: function () {
                                ...
                                if (i.display) {
                                    ...
                                    a.each(t.ticks, function (i, s) {
                                        if (s > 0 || r.reverse) {
                                            var u =
                                                t.getDistanceFromCenterForValue(
                                                    t.ticksAsNumbers[s]
                                                );
                                            if (
                                                (n.display &&
                        ...
                        var e = t.Scale.extend({
                            ...
                            update: function () {
                                ...
                                return (
                                    ...
                                    t.Scale.prototype.update.apply(
                                        this,
                                        arguments
                                    )
                                );
                            ...
                            determineDataLimits: function () {
                                var t,
                                    ...
                                    _ = [];
                                for (
                                    t = 0, i = f.data.labels.length;
                                    t < i;
                                    ++t
                                )
                                    _.push(g(f.data.labels[t], c));
                                for (
                                    t = 0, i = (f.data.datasets || []).length;
                                    t < i;
                                    ++t
                                )
                                    if (f.isDatasetVisible(t))
                                        if (
                                            ((l = f.data.datasets[t].data),
                                            r.isObject(l[0]))
                                        )
                                            for (
                                                x[t] = [], e = 0, a = l.length;
                            ...
                            getLabelCapacity: function (t) {
                                var e =
                                        this.options.time.displayFormats
                                            .millisecond,
