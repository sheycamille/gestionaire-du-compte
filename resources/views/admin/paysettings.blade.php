                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-5">
                            <div class="col-md-4">
                                ...
                                <a class="mb-3 btn btn-primary" href="#" data-toggle="modal"
                                    data-target="#wmethodModal"><i class="fa fa-plus"></i>
                                    Add new</a> <br>
                                        ...
                                        <div id="method{{ $method->id }}" class="panel-collapse collapse">
                                            <div class="sign-u">
                                                ...
                                                <a class="btn btn-primary btn-sm" href="#" data-toggle="modal"
                                                    data-target="#wmethodModal{{ $method->id }}"><i
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form role="form" method="post"
                                                        action="{{ route('updatewdmethod') }}"
                                                        enctype="multipart/form-data">

                                                        <h5 class="">Enter Method Name</h5>
                                                        <input class="form-control" placeholder="Enter method name"
                                                            type="text" name="name" value="{{ $method->name }}"
                                                            required>
                                                        <br>
                                                        <h5 class="">Enter Method Exchange Symbol</h5>
                                                        <input class="form-control"
                                                            placeholder="Enter method exchange symbol" type="text"
                                                        ...
                                                        <input class="form-control" placeholder="Payout duration"
                                                            type="text" name="duration"
                                                            value="{{ $method->duration }}" required>
                                                        <br>
                                                        <h5 class="">Details</h5>
                                                        <textarea class="form-control" name="details" row="3" placeholder="Method details" rows="10"
                                                            cols="20">{!! $method->details !!}</textarea>
                                                        <br />
                                                        <h5 class="">Countries</h5>
                                                        <select style="padding:5px;" class="form-control"
                                                            placeholder="Permitted Countries" type="text"
                                                            ...
                                                            @foreach ($countries as $country)
                                                                ...
                                                                @endphp
                                                                <option @if (in_array($country->id . '', $country_ids)) selected @endif
                                                                    value="{{ $country->id }}">
                                                                    {{ $country->name }}</option>
                                                            @endforeach
                                                        </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <a class="mb-3 btn btn-primary" href="#" data-toggle="modal"
                                    data-target="#dmethodModal"><i class="fa fa-plus"></i>
                                    Add new</a> <br>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="method{{ $method->id }}" class="panel-collapse collapse">
                                            <div class="sign-u">
                                                <br />
                                                <a class="btn btn-primary btn-sm" href="#" data-toggle="modal"
                                                    data-target="#dmethodModal{{ $method->id }}"><i
                                                        class="fa fa-pencil"></i>
                                                    Edit</a> &nbsp;
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('deletewdmethod', $method->id) }}">
