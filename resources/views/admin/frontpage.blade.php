                        ...
                        <div class="mb-5 row">
                            <div class="col-12">
                                <nav>
                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                        <a class="mb-2 nav-item nav-link active" id="nav-contact-tab" data-toggle="tab"
                                            href="#3" role="tab" aria-controls="nav-contact"
                                            aria-selected="false">WEBSITE
                                            CONTENTS</a>
                                        <a class="mb-2 nav-item nav-link" id="nav-about-tab" data-toggle="tab"
                                            href="#4" role="tab" aria-controls="nav-about"
                                ...
                                <div class="px-3 py-3 tab-content px-sm-0" id="nav-tabContent">
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <form action="{{ route('updatecontents') }}"
                                                                        method="post">
                                                                        {{ csrf_field() }}
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="content" placeholder="Describe the content"
                                                                                class="form-control bg-{{ Auth('admin')->User()->dashboard_style }} " rows="2" required>{{ $content->description }}</textarea>
                                                                        </div>
                                    ...
                                    <div class="tab-pane fade card bg-{{ Auth('admin')->User()->dashboard_style }} p-3"
                                        id="4" role="tabpanel" aria-labelledby="nav-about-tab">
                                        <div class="boxes">
                                            <div class="row">
                                                @foreach ($images as $image)
                                                    ...
                                                    <div id="editimg{{ $image->id }}" class="modal fade"
                                                        role="dialog">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div
                                                                    ...
                                                                    <form action="{{ route('updateimg') }}"
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea name="img_desc" placeholder="Describe the image"
                                                                                class="form-control bg-{{ Auth('admin')->User()->dashboard_style }} " rows="2">{{ $image->description }}</textarea>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <h5 class="">Image</h5>
                                                                            <input name="image"
