                        ...
                        <div class="row mb-5">
                            <div class="col-lg-8 offset-lg-2 card p-3">
                                <form class="col-12" action="{{ route('addaccounttype') }}" method="post">
                                    ...
                                    <div class="form-group{{ $errors->has('min_trade_size') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('max_trade_size') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('num_indices_pairs') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('trading_platforms') ? ' has-error' : '' }}">
                                        ...
                                        <div>
                                            <input style="padding:5px;" class="form-control "
                                                ...
                                                name="trading_platforms" value="{{ old('trading_platforms') }}" required>
                                    ...
                                    <div class="form-group{{ $errors->has('typical_spread') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('execution_type') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('educational_material') ? ' has-error' : '' }}">
                                        <h5 class="">Educational Material
                                        </h5>
                                        <div>
                                            <select name="educational_material">
                                                <option selected disabled>Choose Availability</option>
                                                <option @if (old('educational_material') == 1) selected @endif value="1">
                                                    Yes
                                                </option>
                                                <option @if (old('educational_material') == 0) selected @endif value="0">
                                                    No
                                                </option>
                                            </select>
