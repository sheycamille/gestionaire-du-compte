...
@section('content')
    ...
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> @lang('message.chgepass.change')
        </h3>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <form class="forms-sample" method="post" action="{{ route('updatepass') }}">
                        <input type="hidden" name="name" value="{{ Auth::user()->name }}" />
                        <div class="form-group">
                            <label class="">@lang('message.chgepass.old')</label>
                            <input type="password" name="old_password" class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label class=""> @lang('message.chgepass.new')* :</label>
                            <input type="password" name="password" class="form-control" required>
                        </div>
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <div class="form-group">
                            <label class=""> @lang('message.chgepass.knfrm')*:</label>
                            <input type="password" name="password_confirmation" class="form-control" required>
                        </div>
                        <input type="submit" class="btn btn-gradient-primary me-2" value="@lang('message.chgepass.sub')">
