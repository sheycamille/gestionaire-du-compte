    ...
    <div id="content">
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">@lang('message.body.deposits')</h1>
            </div>
...
@section('content')
    ...
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> @lang('message.body.deposits')
        </h3>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <button type="button" href="#" data-bs-toggle="modal" data-bs-target="#depositModal"
                    class="btn btn-primary me-4"><i class="mdi mdi-calendar-plus"></i> @lang('message.body.new_depo')</button>
