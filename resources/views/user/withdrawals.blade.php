...
@section('content')
    ...
    <div class="page-header">
        <h3 class="page-title">
            ...
            </span> @lang('message.body.my_with')
        </h3>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <button type="button" href="{{ route('mwithdrawal') }}"
                    class="btn btn-primary me-4"><i class="mdi mdi-calendar-plus"></i> @lang('message.body.new_with')</button>
