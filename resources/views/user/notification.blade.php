                                                ...
                                                @forelse($Notif as $notification)
                                                    <tr>
                                                        <td> <a href="#" data-toggle="modal"
                                                                ...
                                                                class=" ">
                                                                {{ substr($notification->message, 0, 85) }}
                                                            </a> </td>
                                                    ...
                                                    <div id="message{{ $notification->id }}" class="modal fade"
                                                        role="dialog">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        @forelse($Notif as $notification)
                            <tr>
                                <td> <a href="#" data-toggle="modal" data-target="#message{{ $notification->id }}"
                                        class=" ">
                                        {{ substr($notification->message, 0, 85) }}
                                    </a> </td>
                                <td> {{ \Carbon\Carbon::parse($notification->created_at)->toDayDateTimeString() }}
                                </td>
                                <td> <a href="{{ route('delnotif') }}/{{ $notification->id }}" type="button"
                        ...
                        @empty
                            <tr>
                                <td colspan="3">No Notificaitons</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
