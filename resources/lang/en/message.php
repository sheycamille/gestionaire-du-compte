...
return [
    ...
    'home' => [
        ...
        'why_us' => 'Why Gestion du Patrimoine is a trusted FX broker?',
    ...
    'webtrader' => [
        ...
        'webtrader_platform' => '  Our WebTrader platform is fast becoming one of the most popular used by traders, providing an added level of market analysis and access to full market depth on an impressive and fully customisable user interface. Alongside Gestion du Patrimoine’s advanced trading infrastructure, competitive pricing and superior order execution with no dealing desk intervention*, our WebTrader provides one of the most innovative trading experiences in the industry.',
    ...
    'about' => [
        ...
        'aim' => 'At Gestion du Patrimoine we evolve with the times. We aim to continuously refine our services to cater to the needs of traders in this highly dynamic industry',
        ...
        'phil_text' => 'At Gestion du Patrimoine, we strive to bring innovative products to our clients. We  continuously refine our services to cater to the needs of traders in this highly dynamic industry.',
    ...
    'security' => [
        ...
        'safety' => 'At Gestion du Patrimoine, the safety of client data is a priority and we have sophisticated security measures in place designed to protect your personal information, privacy and funds',
        ...
        'disclose_pt2' => 'Gestion du Patrimoine and other reputable companies would never ask for such details and you should deem any such contact or requests to be suspicious',
        ...
        'for_clarity' => 'For clarity, we would like to highlight that Gestion du Patrimoine',
        ...
        'fraud_pt2' => 'If you receive any unsolicited calls, emails or SMS claiming to be Gestion du Patrimoine, do not engage in any communication and report this to us immediately via our official communication channels on our website',
    ...
    'trading_platforms' => [
        ...
        'more_features' => 'Enjoy more features with Gestion du Patrimoine’ Trader7 trading platform. The Gestion du Patrimoine Trader7 is the latest and most advanced Trader7 platform that offers all the pioneering features of MT4, with the addition of more advanced trading tools and indicators that enable traders to maintain more control of their trades and make more informed decisions using cutting-edge analysis',
    ...
    'privacy_policy' => [
        ...
        'b1' => 'Gestion du Patrimoine is always looking to improve the experience of our clients in more ways than one and in
        an effort to create and manage every trading account our clients have, the company will need to
        access some necessary information from them. The Policy on Privacy Protection indicates how Gestion du Patrimoine
        ...
        'security' => 'Security',
        'cookies' => 'Cookies on GestionDuPatrimione.net',
        ...
        'links' => 'Links',
        'b13' => 'Our website, Gestion du Patrimoine.com, may contain links to other websites on the internet. We are not, in
    ...
    'order_execution' => [
        ...
        'b1' => 'The sole purpose of this Order of Execution policy is to establish a well-organized action plan for the procurement process by providing the finest conceivable result for its Clients, while Gestion du Patrimoine accomplishing a Clients’ orders.',
        ...
        'b3' => 'The policy shall apply automatically upon the completion of trades on behalf of its Clients. Gestion du Patrimoine will continually be the principal counterparty as the orders of Clients are accomplished.',
        'b4' => 'More so, Gestion du Patrimoine cannot assure that once an order is given, the Client’s expense will be beneficial than original value which could perhaps be obtainable in a different occurrence. ',
        'exe' => 'Execution Aspects',
        'b5' => 'Gestion du Patrimoine is required to take several aspects into deliberation; the following are itemized below:',
        'b6' => 'More so, Gestion du Patrimoine cannot assure that once an order is given, the Client’s expense will be beneficial than original value which could perhaps be obtainable in a different occurrence.',
        'quotes' => ' Quotes',
        'b7' => 'Gestion du Patrimoine creates an owned tradable values taken from the figures obtained over the liberated price sources, counting banks that principally offers liquescency through the global market. Gestion du Patrimoine is to guarantee that the bid/ask spread controls is completed with the recommendation to an extensive assortment of fundamental price sources, counting statistical bases. With such, Gestion du Patrimoine can assure that the Client receives the best execution possible. ',
        'charges' => ' Charges',
        ...
        'b9' => 'Orders are positioned in portion scopes. A component which processes the quantity of the deal is termed as “lot”, in which varies from every financial instruments given. If a Client desired to instigate an outsized scope of order, it may not be as much as favorable in several circumstances as liquidity ascends in the marketplace. Gestion du Patrimoine holds the right to refuse a Clients’ Order, if the size of the order is considered to be too large and cannot be completed by Gestion du Patrimoine. ',
        'frequency' => 'Frequency',
        'b10' => 'Normally, Price values often changes in every coming periods. The regularity with which they do varies with financial instruments along with the current market conditions. As Gestion du Patrimoine produces its own tradable price values, the technology therefore used by the Client to make relations with Gestion du Patrimoine will play a decisive function. Additionally, tradable prices are distributed through the Gestion du Patrimoine’s trading programs.',
        'instruments' => 'Instruments',
        'b11' => 'Gestion du Patrimoine fulfills orders in relation to any trading instruments in derivatives on foreign exchange ("FX").',
        'b12' => 'Gestion du Patrimoine provides the following foreign exchange trading products:',
        ...
        'l6' => 'When an order of a Client is being accomplished, Gestion du Patrimoine is authorized to layout the following factors into observation:',
        ...
        'b13' => 'In circumstances where the Client is given with a definite directive by Gestion du Patrimoine concerning the order execution and the company decided on this directive, consequently, an execution of order will be executed with the specific instruction given.',
        'b14' => 'Still, if the Client wanted to perform an order and given a certain instruction, then by executing that order, Gestion du Patrimoine will fulfill with Gestion du Patrimoine’s responsibility to deliver the best execution for the Client. This may possible result in being unqualified to comply with Gestion du Patrimoine’s order execution policy for that certain order.',
        ...
        'b16' => 'In general, the funds placed in the accounts by Clients with Gestion du Patrimoine, counting orders that are positioned towards a trading platform is secured by Gestion du Patrimoine and is the one accountable for the capitals entirely. ',
        'review' => 'Review and Monitoring',
        'b21' => 'Gestion du Patrimoine’s implemented policy will definitely be monitored, including the substantial order execution provisions, predominantly on an constant foundation to regulate and suggest better improvements.',
        'b17' => 'It is also mandatory for the company to evaluate the Policy and the pertinent order execution preparations on a systematic basis in any case so as to measure if Gestion du Patrimoine is competent enough to deliver the best execution for its Clients. ',
        'permissions' => 'Clients Permissions',
        'b18' => 'Gestion du Patrimoine is required to get the Client’s prior approval to this Policy when making a business association regarding the Client. Furthermore, Gestion du Patrimoine is mandated to take in the Client’s prior approval before the implementation of Clients’ orders or getting or conducting orders for execution.',
        'b19' => 'Gestion du Patrimoine is capable to acquire the abovementioned agreements under a broad settlement.',
        'b20' => 'Gestion du Patrimoine will accomodate Clients who acquired the Policy or sanctioned to take the Policy by electronic means or any other online transactions including those who have largely settled upon on the Trading Terms and Conditions of Gestion du Patrimoine. ',
        'contact' => 'Contact',
    ...
    'terms_service' => [
        ...
        herein. This document, which is a legal contract between the client and Gestion du Patrimoine (“Gestion du Patrimoine ,” “Company,” “we,” “us,” “our”), shall determine the responsibilities and rights of Gestion du Patrimoine and its clients in connection with the Company’s services.',
        ...
        capable of managing transactions on a regular basis. Gestion du Patrimoine has provided a Declaration
        ...
        'b5' => 'Gestion du Patrimoine powered by Gestion du Patrimoine Ltd. (Registration No. 936729). A Company with
    ...
    'headings' => [
        'head' => 'HEADINGS',
        'b1' => '“Gestion du Patrimoine” refers to the Company, affiliates, subordinates, and their beneficiaries;',
    ...
    'application' => [
        ...
        obligations and rights set at the time that the Client started to trade using Gestion du Patrimoine
    ...
    'eligibility' => [
        ...
        services Gestion du Patrimoine provides are intended only for clients who are not prohibited by
    ...
    'offerings' => [
        ...
        'b1' => "Gestion du Patrimoine offers a variety of trading Services to clients and these include
    ...
    'funding' => [
        ...
        to the withdrawal. It is the exclusive right of Gestion du Patrimoine to reject any other withdrawal
    ...
    'client_fund' => [
        'head' => 'CLIENT FUND ',
        'b1' => "Gestion du Patrimoine shall be allowed to keep the client's funds for the use of trading. Losses
    ...
    'fund_transfer' => [
        ...
        account, the Client affirms that such action is performed under his/her own risk, as Gestion du Patrimoine cannot be held liable for your action and is not obliged to make any
        ...
        should submit a formal request subject to approval. Gestion du Patrimoine may dismiss funds
        transfer requests. ',
    ...
    'responsibility' => [
        ...
        'b7' => 'All conversations between the Client and Gestion du Patrimoine workforces may be electronically
        ...
        recordings are sole properties of the Company; Gestion du Patrimoine therefore reserves the
    ...
    'bonus' => [
        ...
        the required trading volume determined by Gestion du Patrimoine is met (minimum trading
        ...
        the trading account of the Client. Gestion du Patrimoine also reserves the right to block the
        Client's trading account and return the balance to the Client.",

    ],
    'seclusion' => [
        'head' => 'SECLUSION OF CLIENT FUNDS AND CURRENCY CONVERSIONS   ',
        'b1' => "Gestion du Patrimoine shall conduct money it holds on the Client's behalf as clients' funds. The
        ...
        'b2' => "Gestion du Patrimoine coordinates with various credit institutions; a complete list of these
    ...
    'fees' => [
        ...
        'b1' => "Clients may be required to pay the cost and charges outlined in Gestion du Patrimoine's Service
        ...
        that instituted the professional connection between the Gestion du Patrimoine workforces and
        the clients.  ",
    ...
    'margin' => [
        ...
        changed at any time. Gestion du Patrimoine may impose maximum requirements to comply with
        ...
        account and margin level, while Gestion du Patrimoine may elect to limit the trades and
    ...
    'abritage' => [
        ...
        'b1' => "Gestion du Patrimoine strictly prohibits any form of arbitrage and manipulation of its platform,
    ...
    'derivatives_policy' => [
        ...
        matter. Gestion du Patrimoine can execute orders of the client, but is not obliged to do so,
    ...
    'investment_advice' => [
        ...
        'b1' => "Based on what the Company considers reliable, Gestion du Patrimoine and all its workforces
    ...
    'disputes' => [
        ...
        have had with respect to Gestion du Patrimoine regarding such discrepancy since the impossibility
        ...
        regardless of further impact of profit or loss from the total amount of profit and loss. Noncompliance with these actions is seen as an inability to mitigate losses. The Client must submit any complaints to Gestion du Patrimoine in writing to the email address:
        support@gestiondupatrimoine.net. ',
        'b4' => 'Within thirty (30) business days, Gestion du Patrimoine must verify any written
        ...
        agrees to pay Gestion du Patrimoine reputational damages of $100.00 per day from the time of
        such violation, while the cumulative maximum of the payment may reach $10,000.00.',
        'b6' => 'The Client and Gestion du Patrimoine undertake to make every effort to resolve any dispute, in good
        faith and on a constructive basis. The Client acknowledges and agrees that threats and/or
        blackmail against Gestion du Patrimoine is/are prohibited and is/are the legitimate ground/s for the
        termination of negotiations and the immediate termination of any business relationship.',
        'b7' => 'Without prejudice to any other Gestion du Patrimoine rights under these Terms, if the parties are in
        dispute regarding a trade warrant, Gestion du Patrimoine has the right in its sole discretion and
        without prior notice to accept any opinion and actions that it considers reasonable to limit
        the maximum amount involved in the dispute. Gestion du Patrimoine is not liable to the Customer,
    ...
    'indemnification' => [
        ...
        'b1' => "You acknowledge that Gestion du Patrimoine and its workforces shall not be held liable for any
        losses, costs, expenses and damages that may arise in case the Client fails to
        accomplish his/her obligations in this Agreement. Gestion du Patrimoine is free of liability in all
        claims that may have been contributed by system and/or equipment error of Gestion du Patrimoine
    ...
    'confidential' => [
        ...
        property rights are exclusive property of Gestion du Patrimoine and its licensors. All of these and
    ...
    'termination' => [
        ...
        positions; and that no amount is owed by the Client to Gestion du Patrimoine. The Client may
        ...
        towards the Company, Gestion du Patrimoine reserves the right to call back all profits
        generated from the Company's services. Gestion du Patrimoine has the sole and exclusive
    ...
    'body' => [
        ...
        '2fm' => 'Add additional security to your account using two factor authentication',
        'full_name' => 'Full Name',
    ...
    'gestiondupatrimoine_clients' => 'Gestion du Patrimoine clients are provided with exclusive access to trading tools, news and analysis.',
    'calender' => 'Calender',
    'econs_earning' => 'Economic & Earnings Calendars',
    'analysis' => 'Analysis',
    'trading_central' => 'Trading Central Technical Analysis',
    'reviews' => 'Reviews',
    'daily_market_reviews' => 'Daily market reviews from the Gestion du Patrimoine Analyst Team',
    'knowledge' => 'Knowledge',
    ...
    'why_trade' => 'Why Trade with Gestion du Patrimoine',
    ...
    'platforms' => 'We provide our clients with a wide range of desktop, web and mobile trading platforms including Gestion du Patrimoine platform Trader 7 and WebTrader.',
    'gestiondupatrimoine_platform' => 'Gestion du Patrimoine Platform',
    ...
    'growth' => 'Gestion du Patrimoine has grown exponentially over the years and has become renowned for providing elite trading conditions to its clients',
    ...
    'your_data' => 'How Gestion du Patrimoine Protects Your Data',
    ...
    'copyright' => 'Copyright © 2022 Gestion du Patrimoine. All rights reserved.',
    ...
    'forex_chart' => 'Forex Market Fundamental Data',
    'trader' => 'TRADER',
    'trader_sub' => 'Download our Trader',
    'web_mobile_apps' => 'Web & Mobile Apps',
    'desktop_apps' => 'Desktop Apps',
    'send_message' => 'Send us a message',
    'our_supported_platforms' => 'Our Supported Platforms',
    'launch' => 'Launch',
    '_webtd' => 'WebTrader',
    'get_' => 'Get it on the ',
    '_google_play' => 'Google Play ',
    'available_' => 'Available on the ',
    '_app_store' => 'App Store',
    'Down_w' => 'Download for ',
    '_windows' => 'Windows',
    'down_m' => 'Download for ',
    '_mac' => 'Mac',
